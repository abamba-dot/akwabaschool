...
-- Extension et index pour recherche texte
CREATE EXTENSION IF NOT EXISTS pg_trgm;
CREATE INDEX idx_eleves_recherche ON eleves USING gin (nom gin_trgm_ops, prenom gin_trgm_ops);
...
-- REMOVED en V1.1 : trigger unidirectionnel qui ne gérait pas les
-- annulations/remboursements. Le statut de paiement est calculé côté app
-- ou via la vue vue_eleves_statut (à créer si besoin).
